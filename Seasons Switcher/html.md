...
<body>
    <div>
        ...
        <div class="d-flex flex-row justify-content-center mt-4">
            <button onclick="onSpring()" class="button spring-button" id="springBtn">Spring</button>
            <button onclick="onSummer()" class="button summer-button" id="summerBtn">Summer</button>
            <button onclick="onAutumn()" class="button autumn-button" id="autumnBtn">Autumn</button>
            <button onclick="onWinter()" class="button winter-button" id="winterBtn">Winter</button>
        </div>
    </div>
</body>
